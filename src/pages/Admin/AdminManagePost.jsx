...
const AdminManagePost = () => {
  ...
  const tempUsers = [
    { 
      ...
      preference: '휴양',
      reports: [
        { id: 1, type: 'post', title: '미안하다 이거 보여주려고 어그로끌었다...', content: '나루토 사스케 싸움수준 ㄹㅇ실화냐? 진짜 세계관최강자들의 싸움이다', reportDate: '2024. 08. 01.' },
        { id: 2, type: 'post', title: '나루토 사스케 싸움수준 ㄹㅇ실화냐?', content: '진짜 세계관최강자들의 싸움이다', reportDate: '2024. 08. 08.' },
        { id: 3, type: 'comment', content: '와 개쩐다 진짜 세계관 최강자들의 싸움이다', reportDate: '2024. 08. 15.' },
      ]
    },
    { 
      userId: 'lsy1307', 
